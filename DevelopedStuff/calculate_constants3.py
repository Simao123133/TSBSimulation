...
def constants3(states, parameters, u_z, u_phi):
    ...
    cl0_LF = p00 + p01*Re_LF + p02*Re_LF**2 + p03*Re_LF**3 + p04*Re_LF**4 + p05*Re_LF**5
    cl1_LF = p11*Re_LF + p12*Re_LF**2 + p13*Re_LF**3 + p14*Re_LF**4 + p10
    cl2_LF = p21*Re_LF + p22*Re_LF**2 + p23*Re_LF**3 + p20
    cl3_LF = p31*Re_LF + p32*Re_LF**2 + + p30

    cl4_LF = cl0_LF**2
    cl5_LF = 2*cl1_LF*cl0_LF
    cl6_LF = 2*cl2_LF*cl0_LF + cl1_LF**2
    cl7_LF = cl3_LF*cl0_LF + 2*cl2_LF*cl1_LF + cl0_LF*cl3_LF
    cl8_LF = cl2_LF**2 + 2*cl1_LF*cl3_LF
    cl9_LF = 2*cl2_LF*cl3_LF
    cl10_LF = cl3_LF**2
    
    cl0_RF = p00 + p01*Re_RF + p02*Re_RF**2 + p03*Re_RF**3 + p04*Re_RF**4 + p05*Re_RF**5
    cl1_RF = p11*Re_RF + p12*Re_RF**2 + p13*Re_RF**3 + p14*Re_RF**4 + p10
    cl2_RF = p21*Re_RF + p22*Re_RF**2 + p23*Re_RF**3 + p20
    cl3_RF = p31*Re_RF + p32*Re_RF**2 + + p30

    cl4_RF = cl0_RF**2
    cl5_RF = 2*cl1_RF*cl0_RF
    cl6_RF = 2*cl2_RF*cl0_RF + cl1_RF**2
    cl7_RF = cl3_RF*cl0_RF + 2*cl2_RF*cl1_RF + cl0_RF*cl3_RF
    cl8_RF = cl2_RF**2 + 2*cl1_RF*cl3_RF
    cl9_RF = 2*cl2_RF*cl3_RF
    cl10_RF = cl3_RF**2
    ...
    cd0_LF = p00 + p01*Re_LF + p02*Re_LF**2 + p03*Re_LF**3 + p04*Re_LF**4 + p05*Re_LF**5
    cd1_LF = p11*Re_LF + p12*Re_LF**2 + p13*Re_LF**3 + p14*Re_LF**4 + p10
    cd2_LF = p21*Re_LF + p22*Re_LF**2 + p23*Re_LF**3 + p20
    cd3_LF = p31*Re_LF + p32*Re_LF**2 + + p30

    cd0_RF = p00 + p01*Re_RF + p02*Re_RF**2 + p03*Re_RF**3 + p04*Re_RF**4 + p05*Re_RF**5
    cd1_RF = p11*Re_RF + p12*Re_RF**2 + p13*Re_RF**3 + p14*Re_RF**4 + p10
    cd2_RF = p21*Re_RF + p22*Re_RF**2 + p23*Re_RF**3 + p20
    cd3_RF = p31*Re_RF + p32*Re_RF**2 + + p30
    ...
    a48 = a38*cl9_LF
    a49 = a38*cl8_LF
    a50 = a29*cl3_LF + a38*cl7_LF + a40*cd3_LF
    a51 = a29*cl2_LF + a38*cl6_LF + a40*cd2_LF
    a52 = a29*cl1_LF + a38*cl5_LF + a40*cd1_LF
    a53 = a29*cl0_LF + a38*cl4_LF + a40*cd0_LF

    a54 = a39*cl10_RF
    a55 = a39*cl9_RF
    a56 = a39*cl8_RF
    a57 = a30*cl3_RF + a39*cl7_RF + a41*cd3_RF
    a58 = a30*cl2_RF + a39*cl6_RF + a41*cd2_RF
    a59 = a30*cl1_RF + a39*cl5_RF + a41*cd1_RF
    a60 = a30*cl0_RF + a39*cl4_RF + a41*cd0_RF
    ...
    a63 = a43*cl9_LF
    a64 = a43*cl8_LF
    a65 = a10*cl3_LF + a43*cl7_LF + a44*cd3_LF
    a66 = a10*cl2_LF + a43*cl6_LF + a44*cd2_LF
    a67 = a10*cl1_LF + a43*cl5_LF + a44*cd1_LF
    a68 = a10*cl0_LF + a43*cl4_LF + a44*cd0_LF

    a69 = a45*cl10_RF
    a70 = a45*cl9_RF
    a71 = a45*cl8_RF
    a72 = a11*cl3_RF + a45*cl7_RF + a46*cd3_RF
    a73 = a11*cl2_RF + a45*cl6_RF + a46*cd2_RF
    a74 = a11*cl1_RF + a45*cl5_RF + a46*cd1_RF
    a75 = a11*cl0_RF + a45*cl4_RF + a46*cd0_RF
    ...
    return a47, a48, a49, a50, a51, a52, a54, a55, a56, a57, a58, a59, a77, a62, a63, a64, a65, a66, a67, a69, a70, a71, a72, a73, a74, a78, Re_LF, Re_RF, aa_LF, aa_RF
